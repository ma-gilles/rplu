...
if(NOT TBB_VERSION)
  # Legacy TBB used tbb_stddef.h; oneTBB moved version macros to version.h.
  set(_TBB_VERSION_HEADER "")
  ...
  if(_TBB_VERSION_HEADER)
    #only read the start of the file
    file(STRINGS
        "${_TBB_VERSION_HEADER}"
        TBB_VERSION_CONTENTS
        REGEX "TBB_VERSION|TBB_INTERFACE_VERSION|TBB_COMPATIBLE_INTERFACE_VERSION")

    foreach(_tbb_line IN LISTS TBB_VERSION_CONTENTS)
      if(_tbb_line MATCHES ".*#define TBB_VERSION_MAJOR ([0-9]+).*")
        set(TBB_VERSION_MAJOR "${CMAKE_MATCH_1}")
      endif()
      if(_tbb_line MATCHES ".*#define TBB_VERSION_MINOR ([0-9]+).*")
        set(TBB_VERSION_MINOR "${CMAKE_MATCH_1}")
      endif()
      if(_tbb_line MATCHES ".*#define TBB_INTERFACE_VERSION ([0-9]+).*")
        set(TBB_INTERFACE_VERSION "${CMAKE_MATCH_1}")
      endif()
      if(_tbb_line MATCHES ".*#define TBB_COMPATIBLE_INTERFACE_VERSION ([0-9]+).*")
        set(TBB_COMPATIBLE_INTERFACE_VERSION "${CMAKE_MATCH_1}")
      endif()
    endforeach()
    if(NOT TBB_COMPATIBLE_INTERFACE_VERSION AND TBB_INTERFACE_VERSION)
      set(TBB_COMPATIBLE_INTERFACE_VERSION "${TBB_INTERFACE_VERSION}")
    endif()
  endif()
endif()
